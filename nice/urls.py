...
urlpatterns = patterns('',
    ...
    url(r'^get/(?P<netid>\S+)/(?P<last_updated>\d+)/(?P<start_date>\d+)/(?P<end_date>\d+)$', views.events_json, name='events-json'),
    url(r'^get/(?P<netid>\S+)/(?P<last_updated>\d+)/(?P<start_date>\d+)$', views.events_json, name='events-json'),
    url(r'^get/(?P<netid>\S+)/(?P<last_updated>\d+)$', views.events_json, name='events-json'),
    url(r'^get/(?P<netid>\S+)$', views.events_json, name='events-json'),
    url(r'^put/(?P<netid>\S+)$', views.modify_events, name='modify_events'),
