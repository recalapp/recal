...
class Timer
{
    ...
    private set observerTimeoutId(value: number) { this._observerTimeoutId = value; }
    ...
    constructor(action: ()=>void, interval: number, repeating: boolean = false, idleInterval?: number, idleLimit: number = 60 * 1000)
    {
