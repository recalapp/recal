...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User_Profile.ui_state_restoration'
        db.add_column(u'nice_user_profile', 'ui_state_restoration',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User_Profile.hidden_events'
        db.add_column(u'nice_user_profile', 'hidden_events',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'User_Profile.ui_state_restoration'
        db.delete_column(u'nice_user_profile', 'ui_state_restoration')

        # Deleting field 'User_Profile.hidden_events'
        db.delete_column(u'nice_user_profile', 'hidden_events')
