...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.term_code'
        db.add_column(u'nice_semester', 'term_code',
                      self.gf('django.db.models.fields.CharField')(default='1144', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.term_code'
        db.delete_column(u'nice_semester', 'term_code')
