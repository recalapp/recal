...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event_Group.registrar_id'
        db.add_column(u'nice_event_group', 'registrar_id',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event_Group.registrar_id'
        db.delete_column(u'nice_event_group', 'registrar_id')
