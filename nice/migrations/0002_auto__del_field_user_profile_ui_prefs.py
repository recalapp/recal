...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User_Profile.ui_prefs'
        db.delete_column(u'nice_user_profile', 'ui_prefs')


    def backwards(self, orm):
        # Adding field 'User_Profile.ui_prefs'
        db.add_column(u'nice_user_profile', 'ui_prefs',
