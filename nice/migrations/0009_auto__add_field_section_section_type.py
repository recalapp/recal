...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.section_type'
        db.add_column(u'nice_section', 'section_type',
                      self.gf('django.db.models.fields.CharField')(default='LEC', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.section_type'
        db.delete_column(u'nice_section', 'section_type')
