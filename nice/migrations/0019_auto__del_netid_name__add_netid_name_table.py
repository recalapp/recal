...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NetID_Name'
        db.delete_table(u'nice_netid_name')

        # Adding model 'NetID_Name_Table'
        db.create_table(u'nice_netid_name_table', (
            ('netid', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True)),
        ...
        db.send_create_signal(u'nice', ['NetID_Name_Table'])


    def backwards(self, orm):
        # Adding model 'NetID_Name'
        db.create_table(u'nice_netid_name', (
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('netid', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True)),
        ))
        db.send_create_signal(u'nice', ['NetID_Name'])

        # Deleting model 'NetID_Name_Table'
        db.delete_table(u'nice_netid_name_table')
    ...
    models = {
        ...
        u'nice.netid_name_table': {
            ...
            'netid': ('django.db.models.fields.CharField', [], {'max_length': '20', 'primary_key': 'True'})
        },
        u'nice.pointchange': {
