...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User_Section_Table.color'
        db.add_column(u'nice_user_section_table', 'color',
                      self.gf('colorfield.fields.ColorField')(default='#84D7DB', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User_Section_Table.color'
        db.delete_column(u'nice_user_section_table', 'color')
    ...
    models = {
        ...
        u'nice.user_section_table': {
            ...
            'color': ('colorfield.fields.ColorField', [], {'default': "'#84D7DB'", 'max_length': '7'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.Section']"}),
