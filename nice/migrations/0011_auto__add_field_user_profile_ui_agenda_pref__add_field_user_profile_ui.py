...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User_Profile.ui_agenda_pref'
        db.add_column(u'nice_user_profile', 'ui_agenda_pref',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User_Profile.ui_calendar_pref'
        db.add_column(u'nice_user_profile', 'ui_calendar_pref',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User_Profile.ui_agenda_pref'
        db.delete_column(u'nice_user_profile', 'ui_agenda_pref')

        # Deleting field 'User_Profile.ui_calendar_pref'
        db.delete_column(u'nice_user_profile', 'ui_calendar_pref')
