...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course_Listing.dept'
        db.alter_column(u'nice_course_listing', 'dept', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Course_Listing.number'
        db.alter_column(u'nice_course_listing', 'number', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Course_Listing.dept'
        db.alter_column(u'nice_course_listing', 'dept', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Course_Listing.number'
        db.alter_column(u'nice_course_listing', 'number', self.gf('django.db.models.fields.CharField')(max_length=3))
