...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PointChange'
        db.create_table(u'nice_pointchange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nice.User_Profile'])),
            ('why', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nice.Event_Revision'], null=True, blank=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')()),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('relationship', self.gf('django.db.models.fields.IntegerField')(default=9)),
        ))
        db.send_create_signal(u'nice', ['PointChange'])
    ...
    def backwards(self, orm):
        # Deleting model 'PointChange'
        db.delete_table(u'nice_pointchange')
