...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Votes'
        db.create_table(u'nice_votes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nice.User_Profile'])),
            ('voted_on', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nice.Event_Revision'])),
            ('when', self.gf('django.db.models.fields.DateTimeField')()),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'nice', ['Votes'])

        # Adding field 'User_Profile.current_points'
        db.add_column(u'nice_user_profile', 'current_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'User_Profile.pending_points'
        db.add_column(u'nice_user_profile', 'pending_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'User_Profile.last_point_update_time'
        db.add_column(u'nice_user_profile', 'last_point_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Event_Revision.approved'
        db.alter_column(u'nice_event_revision', 'approved', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):
        # Deleting model 'Votes'
        db.delete_table(u'nice_votes')

        # Deleting field 'User_Profile.current_points'
        db.delete_column(u'nice_user_profile', 'current_points')

        # Deleting field 'User_Profile.pending_points'
        db.delete_column(u'nice_user_profile', 'pending_points')

        # Deleting field 'User_Profile.last_point_update_time'
        db.delete_column(u'nice_user_profile', 'last_point_update_time')


        # Changing field 'Event_Revision.approved'
        db.alter_column(u'nice_event_revision', 'approved', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'nice.course_listing': {
            'Meta': {'ordering': "['dept', 'number']", 'object_name': 'Course_Listing'},
        ...
        u'nice.event_group': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'registrar_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        u'nice.event_revision': {
            ...
            'approved': ('django.db.models.fields.CharField', [], {'default': "'S_PE'", 'max_length': '4'}),
        ...
        u'nice.section': {
            'Meta': {'ordering': "['course', 'name']", 'object_name': 'Section'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'section_type': ('django.db.models.fields.CharField', [], {'max_length': '3'})
        },
        u'nice.semester': {
        ...
        u'nice.user_profile': {
            ...
            'current_points': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            ...
            'last_point_update_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'pending_points': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            ...
            'ui_agenda_pref': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ui_calendar_pref': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ui_pref': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'nice.votes': {
            ...
            'voted_on': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.Event_Revision']"}),
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.User_Profile']"}),
