...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NetID_Name_Table.first_name'
        db.alter_column(u'nice_netid_name_table', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'NetID_Name_Table.last_name'
        db.alter_column(u'nice_netid_name_table', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'NetID_Name_Table.netid'
        db.alter_column(u'nice_netid_name_table', 'netid', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))

    def backwards(self, orm):

        # Changing field 'NetID_Name_Table.first_name'
        db.alter_column(u'nice_netid_name_table', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'NetID_Name_Table.last_name'
        db.alter_column(u'nice_netid_name_table', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'NetID_Name_Table.netid'
        db.alter_column(u'nice_netid_name_table', 'netid', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True))
    ...
    models = {
        ...
        u'nice.netid_name_table': {
            'Meta': {'object_name': 'NetID_Name_Table'},
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'netid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'})
        },
        u'nice.pointchange': {
            'Meta': {'object_name': 'PointChange'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'relationship': ('django.db.models.fields.IntegerField', [], {'default': '9'}),
            'score': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.User_Profile']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {}),
            'why': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.Event_Revision']", 'null': 'True', 'blank': 'True'})
        },
        u'nice.section': {
        ...
        u'nice.user_section_table': {
            ...
            'color': ('colorfield.fields.ColorField', [], {'default': "'#8441A5'", 'max_length': '7'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.Section']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nice.User_Profile']"})
        },
