...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course_Listing.is_primary'
        db.add_column(u'nice_course_listing', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course_Listing.is_primary'
        db.delete_column(u'nice_course_listing', 'is_primary')
