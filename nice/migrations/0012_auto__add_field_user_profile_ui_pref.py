...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User_Profile.ui_pref'
        db.add_column(u'nice_user_profile', 'ui_pref',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User_Profile.ui_pref'
        db.delete_column(u'nice_user_profile', 'ui_pref')
