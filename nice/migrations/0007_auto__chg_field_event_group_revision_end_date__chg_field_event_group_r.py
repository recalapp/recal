...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event_Group_Revision.end_date'
        db.alter_column(u'nice_event_group_revision', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Event_Group_Revision.start_date'
        db.alter_column(u'nice_event_group_revision', 'start_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Event_Group_Revision.end_date'
        db.alter_column(u'nice_event_group_revision', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Event_Group_Revision.start_date'
        db.alter_column(u'nice_event_group_revision', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
