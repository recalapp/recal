...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event_Group_Revision.approved'
        db.add_column(u'nice_event_group_revision', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event_Group_Revision.approved'
        db.delete_column(u'nice_event_group_revision', 'approved')
