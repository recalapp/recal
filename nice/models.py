    ...
    def best_revision(self, netid=None):
        ...
        if self.event_revision_set.exists():
            ...
            if netid:
                ...
                if event_vote and (not latest_approved or (event_vote and event_vote.voted_on.modified_time > latest_approved.modified_time)): # if the upvoted revision is newer than the last approved revision, then show the upvoted revision instead.
