define(["require", "exports", './FriendCtrl', './SearchCtrl', './CalendarCtrl', './ScheduleCtrl', './SemCtrl', './MainCtrl', '../Module'], function(require, exports, FriendCtrl, SearchCtrl, CalendarCtrl, ScheduleCtrl, SemCtrl, MainCtrl, Module) {
